	...
	<h1 class="header1">List Of All Customers</h1>
		<table border="1"
			...
			<%
				...
				String custname = request.getParameter("SearchName");
				String mobnumber = request.getParameter("SearchMobile");
				...
				try {
					...
					String query = "select * from jars_customer where customer_name = '"+custname+"' OR customer_phone = '"+mobnumber+"'";
